...
router.post("/:id", function (req, res) {
 return __awaiter(void 0, void 0, void 0, function () {
    let _a; let _id; let timestamp; let name_1; let description; let code; let thumbnail; let price; let stock; let newProductInCart; let err_3;
