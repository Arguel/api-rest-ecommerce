...
const MysqlProducts = /** @class */ (function () {
    ...
    MysqlProducts.prototype.updateProductById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            let _a; let name_2; let description; let code; let thumbnail; let price; let stock; let newProduct; let result; let err_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
    ...
    MysqlProducts.prototype.filter = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            let _a; let name_3; let code_1; let minPrice_1; let maxPrice_1; let minStock_1; let maxStock_1; let result; let err_6;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
