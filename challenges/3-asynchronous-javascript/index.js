...
const recorrerPalabras = function (text, callback, msPerWord) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(i < splitText.length)) return [3 /* break*/, 4];
                    return [4 /* yield*/, new Promise(function (resolve) {
 return setTimeout(resolve, msPerWord);
})];
                case 2:
                    _a.sent();
...
recorrerPalabras(text1, function (res1) {
    recorrerPalabras(text2, function (res2) {
        recorrerPalabras(text3, function (res3) {
