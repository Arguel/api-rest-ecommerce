...
const chat_1 = require("../models/mongodb/chat");
const normalizr_1 = require("normalizr");
const socketIo = function (io) {
    io.on("connection", function (socket) {
 return __awaiter(void 0, void 0, void 0, function () {
        let messagesMongo; let normalizedData;
...
function convertMsgs(data) {
    const newData = data.map(function (msg) {
 return ({
        id: msg._id.toString(),
        author: msg.author,
        date: msg.date,
    ...
    const messagesSchema = new normalizr_1.schema.Array(messageSchema);
