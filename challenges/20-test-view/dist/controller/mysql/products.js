...
var fakerGenerator_1 = require("../../utils/fakerGenerator");
var MysqlProducts = /** @class */ (function () {
    ...
    MysqlProducts.prototype.viewTest = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var noVerify;
            return __generator(this, function (_a) {
                noVerify = parseInt(req.params.qty);
                if (noVerify)
                    res
                        .status(200)
                        .send("" + (0, fakerGenerator_1.gen)(noVerify).map(function (obj) { return obj.name + ", " + obj.price + ", " + obj.thumbnail + " \r\n"; }));
                else if (noVerify === 0)
                    res
                        .status(200)
                    ...
                    res
                        .status(200)
                        .send("" + (0, fakerGenerator_1.gen)(10).map(function (obj) { return obj.name + ", " + obj.price + ", " + obj.thumbnail + " \r\n"; }));
                return [2 /*return*/];
            });
        });
    };
