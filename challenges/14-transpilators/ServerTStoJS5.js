...
const port = 3000;
// Products json
const productsData = fs_1.default.readFileSync(__dirname + "/products.json", "utf-8");
let products = JSON.parse(productsData.toString());
// Messages json
const messagesData = fs_1.default.readFileSync(__dirname + "/userMessages.json", "utf-8");
...
app.post("/api/products", function (req, res) {
    ...
    products = __spreadArray(__spreadArray([], products, true), [newProduct], false);
